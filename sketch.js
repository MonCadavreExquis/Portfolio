...
function setup() {
 ...
 mY = windowHeight*0.1;
  ...
  videoButton = createButton("Vidéo de présentation");
  ...
  //LINKS
  haiku = createA("Haiku.html","Accéder","_blank")
...
interFun = function(){
 ...
 virtuelle.position(mX+w*0.6,mY+w*0.1+h*0.25);
  ...
  virtuelle.show();
   ...
   textSize(textTaille);
  textAlign(LEFT,TOP);
  text("Survole-moi",mX+w*0.17,mY+h*0.58);
  textSize(textTaille*0.6);
   text("Entre le corps et l’écran. Mon portrait réagit à ta souris : un corps virtuel, absent. Mes réponses programmées sont mon fantôme, mon image résiduelle... Un petit sketch créé avec p5.js.",mX+w*0.24,mY+h*0.68, w*0.54,h*0.9);
survole.position(mX+w*0.6,mY+w*0.1+h*0.70);
